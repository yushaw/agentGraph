...
class SessionStore:
    ...
    def __init__(self, db_path: str | Path = None):
        ...
        Args:
            db_path: Path to SQLite database file (defaults to project_root/data/sessions.db)
        """
        if db_path is None:
            # Use project-root-aware path resolution
            from generalAgent.config.project_root import resolve_project_path
            db_path = resolve_project_path("data/sessions.db")
